object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(126); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(333); 
  ...
  val PiSinglePrecisionTimes2 = piSinglePrecision * 2;System.out.println("""PiSinglePrecisionTimes2  : Float = """ + $show(PiSinglePrecisionTimes2 ));$skip(146); 
  println(f"When you multiply PI by 2, and display it with three decimal places of precision to the right, you get $PiSinglePrecisionTimes2%.3f")}
}
