object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def upperCaseIt(x: String, f: String => String) : String = {
  		f(x)
  };System.out.println("""upperCaseIt: (x: String, f: String => String)String""");$skip(47); val res$3 = 
  
  upperCaseIt("haisam", x => x.toUpperCase);System.out.println("""res3: String = """ + $show(res$3))}
