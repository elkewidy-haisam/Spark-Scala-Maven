object LearningScala1 {
  ...
  val PiSinglePrecisionTimes2 = piSinglePrecision * 2
                                                  //> PiSinglePrecisionTimes2  : Float = 6.2831855
  println(f"When you multiply PI by 2, and display it with three decimal places of precision to the right, you get $PiSinglePrecisionTimes2%.3f")
                                                  //> When you multiply PI by 2, and display it with three decimal places of prec
                                                  //| ision to the right, you get 6.283
}